-- Add client_action_url column to orders table
ALTER TABLE public.orders
ADD COLUMN IF NOT EXISTS client_action_url TEXT DEFAULT NULL;
...
-- Recreate client_orders view to include new column while maintaining security filter
