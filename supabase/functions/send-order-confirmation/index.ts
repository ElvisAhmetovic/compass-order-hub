  ...
  try {
    ...
    const emailHtml = `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 800px; margin: 0 auto; padding: 20px; background-color: #f8f9fa;">
        <!-- Header -->
        <div style="background-color: ${isUpdate ? '#059669' : '#1e3a5f'}; color: white; padding: 30px; border-radius: 8px; margin-bottom: 30px; text-align: center;">
          ...
          <div style="background-color: white; padding: 25px; border-radius: 8px; border: 1px solid #e5e7eb;">
            ...
            <div style="space-y: 15px;">
              ...
              <div style="margin-bottom: 15px;">
                ...
                <a href="mailto:${orderData.contact_email}" style="color: #1e3a5f; text-decoration: none;">${orderData.contact_email}</a>
              </div>
              
              ${orderData.contact_phone ? `
              <div style="margin-bottom: 15px;">
                <strong style="color: #374151; display: block; margin-bottom: 5px;">📞 Phone:</strong>
                <a href="tel:${orderData.contact_phone}" style="color: #1e3a5f; text-decoration: none;">${orderData.contact_phone}</a>
              </div>` : ''}
              
              ${orderData.company_link ? `
              <div style="margin-bottom: 15px;">
                <strong style="color: #374151; display: block; margin-bottom: 5px;">🌐 Website:</strong>
                <a href="${orderData.company_link}" target="_blank" style="color: #1e3a5f; text-decoration: none; word-break: break-all;">${orderData.company_link}</a>
              </div>` : ''}
            </div>
          </div>
        ...
        <div style="background-color: white; padding: 25px; border-radius: 8px; border: 1px solid #e5e7eb; margin-bottom: 25px;">
          ...
          <div style="background-color: #f9fafb; padding: 15px; border-radius: 6px; border-left: 4px solid #1e3a5f;">
        ...
        <div style="background-color: #f8f9fa; padding: 25px; border-radius: 8px; margin-top: 30px; text-align: center; border: 1px solid #e5e7eb;">
          <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 14px;">
            This email was automatically generated by AB Media Team.
          </p>
          <p style="margin: 0; color: #6b7280; font-size: 14px;">
            Visit us at: <a href="https://www.empriatech.com" style="color: #1e3a5f; text-decoration: none; font-weight: 500;">AB Media Team</a>
          </p>
        </div>
      </body>
      </html>
