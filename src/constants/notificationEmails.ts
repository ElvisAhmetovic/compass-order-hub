/**
 * Centralized notification email list for all system notifications
 * Used across: Order creation, Order updates, Tech support tickets
 */
export const NOTIFICATION_EMAIL_LIST = [
