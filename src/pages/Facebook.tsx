...
const Facebook = () => {
  ...
  useEffect(() => {
    const handleOrderStatusChange = () => {
      console.log('Facebook: Order status change detected, refreshing data...');
  ...
  const handleRefresh = () => {
    console.log('Facebook: Manual refresh triggered');
    setRefreshTrigger(prev => prev + 1);
  };
      ...
      <div className="flex-1">
        <Layout userRole={userRole}>
          <div className="space-y-6">
            <DashboardHeader 
              title="Facebook Orders"
              description="Manage and track all Facebook-related orders"
              onCreateOrder={isAdmin ? () => setCreateModalOpen(true) : undefined}
              createButtonText="Create Facebook Order"
            />
            
            <DashboardCards statusFilter="Facebook" />
            
            <OrderTable 
              onOrderClick={open} 
              statusFilter="Facebook"
