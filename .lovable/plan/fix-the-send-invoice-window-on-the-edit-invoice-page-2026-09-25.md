...
1. Make the edit invoice Send Invoice button open the **same working window as the preview** (new bank notice text, 10 languages, PDF attached, sent from [noreply@abm-team.com](mailto:noreply@abm-team.com), team gets a copy).
...
dont forget the drop down doesnt work .
